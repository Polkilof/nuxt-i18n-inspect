...
// Версію бере з кореневого package.json, а не з рядка в шапці: зашита руками
// вона розходилась із пакетом на першому ж підйомі версії, а демо показує саме
// той модуль, що лежить поруч. Читаємо на збірці - у браузер їде готове число.
